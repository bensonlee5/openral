...
- `tests/unit/test_image_convert.py` — `rgb8`/`bgr8` → BGR byte
  ...
  padded stride).
- `tests/unit/test_depth_convert.py` — ADR-0085 metric-depth ↔ `32FC1`
